...
@Component({
  selector: 'app-entreprise-devises-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './entreprise-devises-list.Component.html',
  styleUrl: './entreprise-devises-list.Component.scss'
})
export class EntrepriseDevisesListComponent {
