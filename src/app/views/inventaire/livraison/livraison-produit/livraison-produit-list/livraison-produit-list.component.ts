...
@Component({
  selector: 'app-livraison-produit-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './livraison-produit-list.Component.html',
  styleUrl: './livraison-produit-list.Component.scss'
})
export class LivraisonProduitListComponent {
