...
@Component({
  selector: 'app-produit-niveau-prix-create',
  standalone: true,
  imports: [
  ...
  templateUrl: './produit-niveau-prix-create.component.html',
  styleUrl: './produit-niveau-prix-create.component.scss'
})
export class ProduitNiveauPrixCreateComponent {
  ...
  reset(force = true) {
    if (force || this.item == null) this.item = new ProduitNiveauPrix()
